...
```{r Q1 - Predictions}
sarima.pred.full = predict(sarima.fit.full,n.ahead=4)
sarima.pred.full

full.CO2.ts

residuals(sarima.fit.full)
```


#### 2019 Q4
$$ y_{t+1} = y_{t} + y_{t-3} - y_{t-4} + \varepsilon_{t+1} + 0.5614\varepsilon_{t} - 0.8524\varepsilon_{t-3} - 0.4785\varepsilon_{t-4}$$
...
#### 2020 Q1
$$ y_{t+2} = y_{t+1} + y_{t-2} - y_{t-3} + \varepsilon_{t+2} + 0.5614\varepsilon_{t+1} - 0.8524\varepsilon_{t-2} - 0.4785\varepsilon_{t-3}$$
```{r Q1 - Predictions 2020Q1}
#2020Q1
pred.2020Q1 = pred.2019Q4 + 405.83 - 405.83 - (0.8524 * -0.106133913) - (0.4785 * 0.009630730)
pred.2020Q1
```
#### 2020 Q2
$$ y_{t+3} = y_{t+2} + y_{t-1} - y_{t-2} + \varepsilon_{t+3} + 0.5614\varepsilon_{t+2} - 0.8524\varepsilon_{t-1} - 0.4785\varepsilon_{t-2}$$
...
#### 2020 Q3
$$ y_{t+4} = y_{t+3} + y_{t} - y_{t-1} + \varepsilon_{t+4} + 0.5614\varepsilon_{t+3} - 0.8524\varepsilon_{t} - 0.4785\varepsilon_{t-1}$$
...
results.df = data.frame(Time=c("2019.4", "2020.1", "2020.2", "2020.3"),
                           ByHAnd=c(pred.2019Q4,pred.2020Q1,pred.2020Q2,pred.2020Q3),
                           R = sarima.pred.full$pred)
results.df
```
