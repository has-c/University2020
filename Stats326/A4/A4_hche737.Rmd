...
pacf(A4.df$TS2)
```
The plot of the series shows no discrenable pattern. The acf shows cut-off at lag 2 and the pacf shows decay (or persistence). 

This suggests MA(2) is the most suitable model. 
