...
#initial pairs plot
pairs20x(heartHealth.df[c("height", "weight", "sbp", "dbp")], main="Initial Pairs Plot") 

#adjustment 1
heartHealth.df[heartHealth.df["height"] == 15.1, 4] = 1.51 
pairs20x(heartHealth.df[c("height", "weight", "sbp", "dbp")], main="After adjustment 1") 

#adjustment 2
heartHealth.df = heartHealth.df[-c(106), ] 
pairs20x(heartHealth.df[c("height", "weight", "sbp", "dbp")], main="After adjustment 2") 

#adjustment 3
sdp = heartHealth.df[44, "sbp"] 
dbp = heartHealth.df[44, "dbp"] 
heartHealth.df[44, "dbp"] = sdp
heartHealth.df[44, "sbp"] = dbp
pairs20x(heartHealth.df[c("height", "weight", "sbp", "dbp")], main="After adjustment 3") 
```
Adjustment 1
